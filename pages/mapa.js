...
/**
 * Gera ou recupera a URL da logo do mercado.
 * Se o mercado não possuir logo própria, gera um avatar circular com as iniciais da rede.
 */
...
export async function render() {
  const radius = APP_CONFIG?.searchRadiusKm || APP_CONFIG?.location?.defaultRadiusKm || 10;
  return `
